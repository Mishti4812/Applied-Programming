    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT){
            if (resultCode == RESULT_OK ) {
                ...
                if (txt.contains("hello") || txt.contains("Hello")){
                ...
                else if (txt.contains("feeling") || txt.contains("feeling")){
                    ...
                    speaker.speak("I think you have a fever. Please take these medicines");
                }
                else if (txt.contains("my name")){
                    speaker.speak("Your name is "+ personName);
                }
                else if (txt.contains("Thank you") && txt.contains("Thank you")){
                    speaker.speak("Than you too" + personName + "Take care");
                }
            }
        }
    }
