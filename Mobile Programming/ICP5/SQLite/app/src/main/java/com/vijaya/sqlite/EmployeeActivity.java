...
public class EmployeeActivity extends AppCompatActivity {
    ...
    private void updateinDB(){
        ...
        // In case of error do not update
        catch (Exception e) {
            return;
        }
        // Updating database
        SQLiteDatabase dataBase = new SampleDBSQLiteHelper(this).getWritableDatabase();
        dataBase.update(SampleDBContract.Employee.TABLE_NAME,values ,SampleDBContract.Employee.COLUMN_FIRSTNAME + "='" + binding.firstnameEditText.getText().toString() + "'",null);
    ...
    private void deleteFromDB(){
        ...
        dataBase.delete(SampleDBContract.Employee.TABLE_NAME, SampleDBContract.Employee.COLUMN_FIRSTNAME + "='" + binding.firstnameEditText.getText().toString() + "'",null);
    }
}